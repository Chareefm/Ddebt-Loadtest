...
export default function () {
  ...
  //Dashboard
  const dashboardUrl = 'https://ddebt.gsb.or.th/public/api/debt/debtor/dashboardOaAgentAuth';
  ...
  check(dashboardResult, { 'Dashboard was 200': (dashboardResult) => dashboardResult.status === 200 });
  ...
  check(exportResult, { 'Export was 200': (exportResult) => exportResult.status == 201 });
